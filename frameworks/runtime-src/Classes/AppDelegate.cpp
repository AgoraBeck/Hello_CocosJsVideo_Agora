...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("Hello_CocosJsVideo_Agora");
#else
        glview = cocos2d::GLViewImpl::createWithRect("Hello_CocosJsVideo_Agora", Rect(0,0,960,640));
#endif
...
#if ( CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID || CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    sc->addRegisterCallback(register_jsb_agoraVideo);    
